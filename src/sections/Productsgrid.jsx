    ...
    return (
        <div id='products' className='w=full lg:px-20 px-5 py-[80px] bg-gray-100 flex flex-col justify-center items-center gap-4'>
            ...
            <div data-aos="zoom-in" data-aos-delay="300" className='w-full grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-10 mt-10'>
                <div id='product-box' className='flex flex-col justify-center items-center gap-2 bg-white p-4 rounded-lg cursor-pointer relative'>
                    <img src={product} alt=""/>
                    ...
                    <h1 className='text-lg text-gray-400 font-semibold'>Processor</h1>
                    <h1 className='text-xl text-black font-semibold'>Ryzen 5 5600G</h1>
                    <h1 className='text-lg text-themepurple font-semibold'>$6500</h1>
