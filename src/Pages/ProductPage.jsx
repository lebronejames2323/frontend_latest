            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-start gap-4">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className={`bg-themegreen hover:bg-themeyellow hover:text-black text-white font-semibold px-6 py-2 rounded-lg transition ${loading2 ? "opacity-50 cursor-not-allowed" : ""}`} disabled={loading2}
                >
                  Add to Cart
                </button>
                <button
                  onClick={() => addToWishlist(product.id)}
                  className={`bg-gray-200 hover:bg-gray-300 text-black font-semibold px-6 py-2 rounded-lg transition ${loading2 ? "opacity-50 cursor-not-allowed" : ""}`} disabled={loading2}
                >
                  Add to Wishlist
                </button>
              </div>
