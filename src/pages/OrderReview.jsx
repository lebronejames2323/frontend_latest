...
const OrderReview = () => {
  ...
  <div className="w-full max-w-4xl mt-[80px] p-6 bg-white rounded-lg shadow-xl border">
  ...
  <div className="mt-10 w-full max-w-2xl bg-white shadow-lg rounded-lg p-6">
    ...
    <textarea
      className="w-full mt-4 p-3 border rounded-md resize-none focus:ring-2 focus:ring-themegreen"
